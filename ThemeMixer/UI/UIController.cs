...
using ThemeMixer3.UI.Parts.SelectPanels;
using UnityEngine;
    ...
    public class UIController : MonoBehaviour
    {
        ...
        public static UIController Instance
        {
            get
            {
                ...
                if (_instance != null) return _instance;
                GameObject gameObject = GameObject.Find("ThemeMixer3");
                if (gameObject == null) gameObject = new GameObject("ThemeMixer3");
        ...
        private void DestroyUI()
        {
            ...
            if (ThemeMixer3UI == null) return;
            Destroy(ThemeMixer3UI.gameObject);
            ThemeMixer3UI = null;
        }

        private void OnUIToggleClicked()
        {
            if (ThemeMixer3UI != null)
            {
                Destroy(ThemeMixer3UI.gameObject);
                ThemeMixer3UI = null;
                return;
            }
            ThemeMixer3UI = UIView.GetAView().AddUIComponent(typeof(UIRoot)) as UIRoot;
            ThemeMixer3UI?.AddUIComponent<ThemeMixer3UI>();
        }
