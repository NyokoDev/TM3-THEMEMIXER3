...
namespace ThemeMixer3.UI.CategoryPanels
{
    public class LutsPanel : PanelBase
    {
        ...
        {
            bool isRenderItEnabled = ThemeMixer3.ModUtils.ModChecker.IsModEnabled("Render It!");
            ...
            if (isRenderItEnabled)
            {
                ...
                Debug.Log("Theme Mixer 3: Render It! mod is enabled");
            }
            else
            {
                Debug.Log("Theme Mixer 3: Render It! mod is not enabled");
