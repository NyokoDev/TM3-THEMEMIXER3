...
namespace ThemeMixer3.UI.CategoryPanels
{
    public class MixesPanel : PanelBase
    {
        ...
        private PanelBase _saveThemePanel;
        private ButtonPanel _saveThemeButtonPanel;
        ...
        private void CreateSaveThemePanel()
        {
            _saveThemePanel = AddUIComponent<PanelBase>();
            _saveThemePanel.Setup("Save Theme Panel", 350.0f, 0.0f, 5, true, LayoutDirection.Vertical, LayoutStart.TopLeft, "WhiteRect");
            _saveThemePanel.color = UIColorGrey;

            _saveThemePanel.CreateSpace(0.0f, 0.01f);
            CreateSaveThemeButton();
            _saveThemePanel.CreateSpace(0.0f, 0.01f);
        }

        private void CreateSaveThemeButton()
        {
            _saveThemeButtonPanel = _saveThemePanel.AddUIComponent<ButtonPanel>();
            _saveThemeButtonPanel.Setup("Save Theme Button", 340.0f, 30.0f);
            _saveThemeButtonPanel.SetAnchor(UIAnchorStyle.Left | UIAnchorStyle.CenterVertical);
            _saveThemeButtonPanel.SetText(Translation.Instance.GetTranslation(TranslationID.BUTTON_SAVE_THEME));
            _saveThemeButtonPanel.AlignRight();
            _saveThemeButtonPanel.EventButtonClicked += OnSaveThemeClicked;
        }

        private void OnSaveThemeClicked()
        {
